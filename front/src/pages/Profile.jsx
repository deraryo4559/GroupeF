...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        const TARGET_USER_ID = me?.user_id ?? "--"; // 未ログイン時はデフォルト --
            ...
            <div className="flex justify-center h-[calc(100vh-56px)] overflow-auto">
                <div className="min-w-[300px] w-full max-w-sm p-6 bg-gray-50">
                    <div className="space-y-6">
                        ...
                        {/* ユーザー情報カード（Topページと同じUIに、クリック動作なし） */}
                        <UserInfoCardStatic
                        ...
                        <section className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                            <h2 className="text-lg font-semibold text-gray-900 mb-2">基本情報</h2>
                        ...
                        <section className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between items-center py-2">
                                    <span className="text-gray-600">口座残高</span>
